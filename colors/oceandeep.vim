...
highlight CursorLine    gui=None guifg=NONE guibg=#003853
highlight CursorColumn  gui=None guifg=NONE guibg=#003853
...
highlight CursorLine    ctermfg=None ctermbg=Cyan
highlight Special       ctermfg=Magenta
highlight SpecialKey    ctermfg=DarkGrey
highlight Exception     ctermfg=DarkCyan
highlight Repeat   ctermfg=Blue
highlight Conditional   ctermfg=Blue
highlight ModeMsg       ctermfg=Brown
...
highlight StorageClass  ctermfg=98
...
highlight LineNr        ctermbg=Black  ctermfg=LightBlue
highlight Folded        ctermbg=Black ctermfg=DarkCyan
highlight FoldColumn    ctermbg=NONE ctermfg=DarkCyan
" vim: sw=4 ts=4 et
